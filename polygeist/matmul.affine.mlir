// Versione linearizzata con accumulatore
func.func @matmul(
  %arg0: memref<?xi32>, %arg1: memref<?xi32>, %arg2: memref<?xi32>,
  ...
  affine.for %arg6 = 0 to %2 {
    affine.for %arg7 = 0 to %1 {
      %3 = affine.for %arg8 = 0 to %0 iter_args(%arg9 = %c0_i32) -> (i32) {
        %4 = affine.load %arg0[%arg8 + %arg6 * symbol(%0)] : memref<?xi32>
        %5 = affine.load %arg1[%arg7 + %arg8 * symbol(%1)] : memref<?xi32>
        %6 = arith.muli %4, %5 : i32
        %7 = arith.addi %arg9, %6 : i32
        affine.yield %7 : i32
      }
      affine.store %3, %arg2[%arg7 + %arg6 * symbol(%1)] : memref<?xi32>
    }
  }
  return
}

// Versione VLA con accumulatore
...
// Versione linearizzata senza accumulatore
...
// versione VLA senza accumulatore
// func.func @matmul(
//   %arg0: i32, %arg1: i32, %arg2: i32,
//   %arg3: memref<?x?xi32>, %arg4: memref<?x?xi32>, %arg5: memref<?x?xi32>
// ) {
//   %0 = arith.index_cast %arg0 : i32 to index
//   %1 = arith.index_cast %arg1 : i32 to index
//   %2 = arith.index_cast %arg2 : i32 to index
