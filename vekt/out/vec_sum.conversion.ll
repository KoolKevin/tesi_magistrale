...
21:                                               ; preds = %18
  ...
  %28 = call <16 x i32> @llvm.masked.load.v16i32.p0(ptr align 4 %27, <16 x i1> %26, <16 x i32> zeroinitializer)
  %29 = sub i64 %8, %19
  ...
  %35 = call <16 x i32> @llvm.masked.load.v16i32.p0(ptr align 4 %34, <16 x i1> %33, <16 x i32> zeroinitializer)
  ...
  call void @llvm.masked.store.v16i32.p0(<16 x i32> %36, ptr align 4 %42, <16 x i1> %41)
  %43 = add i64 %19, 16
  br label %18
