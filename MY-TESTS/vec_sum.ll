...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %add.ptr = getelementptr inbounds <16 x i32>, ptr addrspace(4) %a, i32 %i.013
  %0 = tail call <16 x i32> @llvm.arc.vvld.w.v512(ptr addrspace(4) %add.ptr)
  %add.ptr4 = getelementptr inbounds <16 x i32>, ptr addrspace(4) %b, i32 %i.013
  %1 = tail call <16 x i32> @llvm.arc.vvld.w.v512(ptr addrspace(4) %add.ptr4)
  %2 = tail call <16 x i32> @llvm.arc.vvadd.w.v512(<16 x i32> %0, <16 x i32> %1)
  %add.ptr7 = getelementptr inbounds <16 x i32>, ptr addrspace(4) %c, i32 %i.013
  tail call void @llvm.arc.vvst.w.v512(<16 x i32> %2, ptr addrspace(4) %add.ptr7)
