...
omp_parallel:                                     ; preds = %entry
  ...
  store ptr %11, ptr %gep_7, align 8
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @1, i32 1, ptr @vec_sum..omp_par, ptr %structArg)
...
define internal void @vec_sum..omp_par(ptr noalias %tid.addr, ptr noalias %zero.addr, ptr %0) #0 {
omp.par.entry:
...
omp.wsloop.region:                                ; preds = %omp_loop.body
  %20 = getelementptr i32, ptr %loadgep_, i64 %19
  %21 = load i32, ptr %20, align 4
  %22 = getelementptr i32, ptr %loadgep_2, i64 %19
  %23 = load i32, ptr %22, align 4
  %24 = add i32 %21, %23
  %25 = getelementptr i32, ptr %loadgep_4, i64 %19
