...
@out = addrspace(4) global [1016 x i32] zeroinitializer, align 4
...
entry:
  tail call void @init_vector(ptr noundef addrspacecast (ptr addrspace(4) @in to ptr), i32 noundef 1024, i32 noundef 1) #4
  tail call void @init_vector(ptr noundef addrspacecast (ptr addrspace(4) @out to ptr), i32 noundef 1016, i32 noundef 0) #4
  tail call void @init_vector(ptr noundef addrspacecast (ptr addrspace(4) @kernel to ptr), i32 noundef 9, i32 noundef 1) #4
  %call = tail call i32 @clock() #4
  tail call void @conv1d(i32 noundef 1016, i32 noundef 1024, i32 noundef 9, ptr noundef addrspacecast (ptr addrspace(4) @out to ptr), ptr noundef addrspacecast (ptr addrspace(4) @in to ptr), ptr noundef addrspacecast (ptr addrspace(4) @kernel to ptr)) #4
  ...
  tail call void @print_vector(ptr noundef addrspacecast (ptr addrspace(4) @out to ptr), i32 noundef 1016) #4
  ...
  tail call void @vectorized_conv1d(i32 noundef 1016, i32 noundef 1024, i32 noundef 9, ptr addrspace(4) noundef @out, ptr addrspace(4) noundef @in, ptr addrspace(4) noundef @kernel) #4
  ...
  tail call void @autovectorized_conv1d(i32 noundef 1016, i32 noundef 1024, i32 noundef 9, ptr addrspace(4) noundef @out, ptr addrspace(4) noundef @in, ptr addrspace(4) noundef @kernel) #4
  ...
  %puts58 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.9)
  tail call void @init_vector(ptr noundef addrspacecast (ptr addrspace(4) @out to ptr), i32 noundef 1016, i32 noundef 0) #4
  %call33 = tail call i32 @clock() #4
  tail call void @vekt_conv1d_wrapper(i32 noundef 1016, i32 noundef 1024, i32 noundef 9, ptr noundef addrspacecast (ptr addrspace(4) @out to ptr), ptr noundef addrspacecast (ptr addrspace(4) @in to ptr), ptr noundef addrspacecast (ptr addrspace(4) @kernel to ptr)) #4
