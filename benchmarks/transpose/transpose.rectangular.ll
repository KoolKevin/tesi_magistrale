...
for.body.lr.ph.split.us:                          ; preds = %entry
  %min.iters.check = icmp ult i32 %N, 8
  %min.iters.check25 = icmp ult i32 %N, 64
  %n.vec = and i32 %N, -64
  %cmp.n = icmp eq i32 %n.vec, %N
  %n.vec.remaining = and i32 %N, 56
  %min.epilog.iters.check = icmp eq i32 %n.vec.remaining, 0
  %n.vec30 = and i32 %N, -8
  %cmp.n31 = icmp eq i32 %n.vec30, %N
  br i1 %min.iters.check, label %iter.check.us.preheader, label %for.body.lr.ph.split.us.split
...
iter.check.us:                                    ; preds = %iter.check.us.preheader, %for.cond.cleanup3.us.loopexit.us
  %i.022.us.us = phi i32 [ %inc9.us.us, %for.cond.cleanup3.us.loopexit.us ], [ 0, %iter.check.us.preheader ]
  %mul.us.us = mul nsw i32 %i.022.us.us, %N
  br label %for.body4.us.us

for.body4.us.us:                                  ; preds = %iter.check.us, %for.body4.us.us
  %j.020.us.us = phi i32 [ 0, %iter.check.us ], [ %inc.us.us, %for.body4.us.us ]
  %add.us.us = add nsw i32 %j.020.us.us, %mul.us.us
  ...
  %mul5.us.us = mul nsw i32 %j.020.us.us, %M
  %add6.us.us = add nsw i32 %mul5.us.us, %i.022.us.us
  ...
  %inc.us.us = add nuw nsw i32 %j.020.us.us, 1
  %cmp2.us.us = icmp slt i32 %inc.us.us, %N
  br i1 %cmp2.us.us, label %for.body4.us.us, label %for.cond.cleanup3.us.loopexit.us, !llvm.loop !45

for.cond.cleanup3.us.loopexit.us:                 ; preds = %for.body4.us.us
  %inc9.us.us = add nuw nsw i32 %i.022.us.us, 1
  %cmp.us.us = icmp slt i32 %inc9.us.us, %M
  br i1 %cmp.us.us, label %iter.check.us, label %for.cond.cleanup, !llvm.loop !46

for.body.lr.ph.split.us.split:                    ; preds = %for.body.lr.ph.split.us
  %ident.check.not = icmp eq i32 %M, 1
  br i1 %ident.check.not, label %for.body.lr.ph.split.us.split.split.us, label %iter.check.preheader
...
for.body.lr.ph.split.us.split.split.us:           ; preds = %for.body.lr.ph.split.us.split
  br i1 %min.iters.check25, label %for.body.lr.ph.split.us.split.split.us.split.us, label %for.body.lr.ph.split.us.split.split.us.split

for.body.lr.ph.split.us.split.split.us.split.us:  ; preds = %for.body.lr.ph.split.us.split.split.us
  br i1 %cmp.n31, label %iter.check.us35.us.us, label %iter.check.us35.us

iter.check.us35.us.us:                            ; preds = %for.body.lr.ph.split.us.split.split.us.split.us
  br label %vec.epilog.vector.body.us.us.us

vec.epilog.vector.body.us.us.us:                  ; preds = %vec.epilog.vector.body.us.us.us, %iter.check.us35.us.us
  %index32.us.us.us = phi i32 [ 0, %iter.check.us35.us.us ], [ %index.next34.us.us.us, %vec.epilog.vector.body.us.us.us ]
  %1 = getelementptr inbounds i32, ptr addrspace(4) %a, i32 %index32.us.us.us
  %wide.load33.us.us.us = load <8 x i32>, ptr addrspace(4) %1, align 4, !tbaa !3
  %2 = getelementptr inbounds i32, ptr addrspace(4) %t, i32 %index32.us.us.us
  store <8 x i32> %wide.load33.us.us.us, ptr addrspace(4) %2, align 4, !tbaa !3
  %index.next34.us.us.us = add nuw i32 %index32.us.us.us, 8
  %3 = icmp eq i32 %index.next34.us.us.us, %N
  br i1 %3, label %for.cond.cleanup, label %vec.epilog.vector.body.us.us.us, !llvm.loop !47

iter.check.us35.us:                               ; preds = %for.body.lr.ph.split.us.split.split.us.split.us
  br label %vec.epilog.vector.body.us.us

for.body4.us.us38.us:                             ; preds = %for.body4.us.us38.us.preheader, %for.body4.us.us38.us
  %j.020.us.us39.us = phi i32 [ %inc.us.us45.us, %for.body4.us.us38.us ], [ %n.vec30, %for.body4.us.us38.us.preheader ]
  %arrayidx.us.us41.us = getelementptr inbounds i32, ptr addrspace(4) %a, i32 %j.020.us.us39.us
  %4 = load i32, ptr addrspace(4) %arrayidx.us.us41.us, align 4, !tbaa !3
  %arrayidx7.us.us44.us = getelementptr inbounds i32, ptr addrspace(4) %t, i32 %j.020.us.us39.us
  store i32 %4, ptr addrspace(4) %arrayidx7.us.us44.us, align 4, !tbaa !3
  %inc.us.us45.us = add nuw nsw i32 %j.020.us.us39.us, 1
  %cmp2.us.us46.us = icmp slt i32 %inc.us.us45.us, %N
  br i1 %cmp2.us.us46.us, label %for.body4.us.us38.us, label %for.cond.cleanup, !llvm.loop !45

vec.epilog.vector.body.us.us:                     ; preds = %vec.epilog.vector.body.us.us, %iter.check.us35.us
  %index32.us.us = phi i32 [ 0, %iter.check.us35.us ], [ %index.next34.us.us, %vec.epilog.vector.body.us.us ]
  %5 = getelementptr inbounds i32, ptr addrspace(4) %a, i32 %index32.us.us
  %wide.load33.us.us = load <8 x i32>, ptr addrspace(4) %5, align 4, !tbaa !3
  %6 = getelementptr inbounds i32, ptr addrspace(4) %t, i32 %index32.us.us
  store <8 x i32> %wide.load33.us.us, ptr addrspace(4) %6, align 4, !tbaa !3
  %index.next34.us.us = add nuw i32 %index32.us.us, 8
  %7 = icmp eq i32 %index.next34.us.us, %n.vec30
  br i1 %7, label %for.body4.us.us38.us.preheader, label %vec.epilog.vector.body.us.us, !llvm.loop !47

for.body4.us.us38.us.preheader:                   ; preds = %vec.epilog.vector.body.us.us
  br label %for.body4.us.us38.us

for.body.lr.ph.split.us.split.split.us.split:     ; preds = %for.body.lr.ph.split.us.split.split.us
  br i1 %cmp.n, label %iter.check.us35.us53, label %iter.check.us35

iter.check.us35.us53:                             ; preds = %for.body.lr.ph.split.us.split.split.us.split
  br label %vector.body.us.us

vector.body.us.us:                                ; preds = %vector.body.us.us, %iter.check.us35.us53
  %index.us.us = phi i32 [ 0, %iter.check.us35.us53 ], [ %index.next.us.us, %vector.body.us.us ]
  %8 = getelementptr inbounds i32, ptr addrspace(4) %a, i32 %index.us.us
  %wide.load.us.us = load <16 x i32>, ptr addrspace(4) %8, align 4, !tbaa !3
  %9 = getelementptr inbounds i32, ptr addrspace(4) %8, i32 16
  %wide.load26.us.us = load <16 x i32>, ptr addrspace(4) %9, align 4, !tbaa !3
  %10 = getelementptr inbounds i32, ptr addrspace(4) %8, i32 32
  %wide.load27.us.us = load <16 x i32>, ptr addrspace(4) %10, align 4, !tbaa !3
  %11 = getelementptr inbounds i32, ptr addrspace(4) %8, i32 48
  %wide.load28.us.us = load <16 x i32>, ptr addrspace(4) %11, align 4, !tbaa !3
  %12 = getelementptr inbounds i32, ptr addrspace(4) %t, i32 %index.us.us
  store <16 x i32> %wide.load.us.us, ptr addrspace(4) %12, align 4, !tbaa !3
  %13 = getelementptr inbounds i32, ptr addrspace(4) %12, i32 16
  store <16 x i32> %wide.load26.us.us, ptr addrspace(4) %13, align 4, !tbaa !3
  %14 = getelementptr inbounds i32, ptr addrspace(4) %12, i32 32
  store <16 x i32> %wide.load27.us.us, ptr addrspace(4) %14, align 4, !tbaa !3
  %15 = getelementptr inbounds i32, ptr addrspace(4) %12, i32 48
  store <16 x i32> %wide.load28.us.us, ptr addrspace(4) %15, align 4, !tbaa !3
  %index.next.us.us = add nuw i32 %index.us.us, 64
  %16 = icmp eq i32 %index.next.us.us, %N
  br i1 %16, label %for.cond.cleanup, label %vector.body.us.us, !llvm.loop !48

iter.check.us35:                                  ; preds = %for.body.lr.ph.split.us.split.split.us.split
  br label %vector.body.us

for.body4.us.us38:                                ; preds = %for.body4.us.us38.preheader, %for.body4.us.us38
  %j.020.us.us39 = phi i32 [ %inc.us.us45, %for.body4.us.us38 ], [ %j.020.us.us39.ph, %for.body4.us.us38.preheader ]
  %arrayidx.us.us41 = getelementptr inbounds i32, ptr addrspace(4) %a, i32 %j.020.us.us39
  %17 = load i32, ptr addrspace(4) %arrayidx.us.us41, align 4, !tbaa !3
  %arrayidx7.us.us44 = getelementptr inbounds i32, ptr addrspace(4) %t, i32 %j.020.us.us39
  store i32 %17, ptr addrspace(4) %arrayidx7.us.us44, align 4, !tbaa !3
  %inc.us.us45 = add nuw nsw i32 %j.020.us.us39, 1
  %cmp2.us.us46 = icmp slt i32 %inc.us.us45, %N
  br i1 %cmp2.us.us46, label %for.body4.us.us38, label %for.cond.cleanup, !llvm.loop !45

vec.epilog.iter.check.us:                         ; preds = %vector.body.us
  br i1 %min.epilog.iters.check, label %for.body4.us.us38.preheader, label %vec.epilog.vector.body.us.preheader

vec.epilog.vector.body.us.preheader:              ; preds = %vec.epilog.iter.check.us
  br label %vec.epilog.vector.body.us

for.body4.us.us38.preheader:                      ; preds = %vec.epilog.middle.block.us, %vec.epilog.iter.check.us
  %j.020.us.us39.ph = phi i32 [ %n.vec, %vec.epilog.iter.check.us ], [ %n.vec30, %vec.epilog.middle.block.us ]
  br label %for.body4.us.us38

vector.body.us:                                   ; preds = %vector.body.us, %iter.check.us35
  %index.us = phi i32 [ 0, %iter.check.us35 ], [ %index.next.us, %vector.body.us ]
  %18 = getelementptr inbounds i32, ptr addrspace(4) %a, i32 %index.us
  %wide.load.us = load <16 x i32>, ptr addrspace(4) %18, align 4, !tbaa !3
  %19 = getelementptr inbounds i32, ptr addrspace(4) %18, i32 16
  %wide.load26.us = load <16 x i32>, ptr addrspace(4) %19, align 4, !tbaa !3
  %20 = getelementptr inbounds i32, ptr addrspace(4) %18, i32 32
  %wide.load27.us = load <16 x i32>, ptr addrspace(4) %20, align 4, !tbaa !3
  %21 = getelementptr inbounds i32, ptr addrspace(4) %18, i32 48
  %wide.load28.us = load <16 x i32>, ptr addrspace(4) %21, align 4, !tbaa !3
  %22 = getelementptr inbounds i32, ptr addrspace(4) %t, i32 %index.us
  store <16 x i32> %wide.load.us, ptr addrspace(4) %22, align 4, !tbaa !3
  %23 = getelementptr inbounds i32, ptr addrspace(4) %22, i32 16
  store <16 x i32> %wide.load26.us, ptr addrspace(4) %23, align 4, !tbaa !3
  %24 = getelementptr inbounds i32, ptr addrspace(4) %22, i32 32
  store <16 x i32> %wide.load27.us, ptr addrspace(4) %24, align 4, !tbaa !3
  %25 = getelementptr inbounds i32, ptr addrspace(4) %22, i32 48
  store <16 x i32> %wide.load28.us, ptr addrspace(4) %25, align 4, !tbaa !3
  %index.next.us = add nuw i32 %index.us, 64
  %26 = icmp eq i32 %index.next.us, %n.vec
  br i1 %26, label %vec.epilog.iter.check.us, label %vector.body.us, !llvm.loop !48

vec.epilog.middle.block.us:                       ; preds = %vec.epilog.vector.body.us
  br i1 %cmp.n31, label %for.cond.cleanup, label %for.body4.us.us38.preheader

vec.epilog.vector.body.us:                        ; preds = %vec.epilog.vector.body.us.preheader, %vec.epilog.vector.body.us
  %index32.us = phi i32 [ %index.next34.us, %vec.epilog.vector.body.us ], [ %n.vec, %vec.epilog.vector.body.us.preheader ]
  %27 = getelementptr inbounds i32, ptr addrspace(4) %a, i32 %index32.us
  %wide.load33.us = load <8 x i32>, ptr addrspace(4) %27, align 4, !tbaa !3
  %28 = getelementptr inbounds i32, ptr addrspace(4) %t, i32 %index32.us
  store <8 x i32> %wide.load33.us, ptr addrspace(4) %28, align 4, !tbaa !3
  %index.next34.us = add nuw i32 %index32.us, 8
  %29 = icmp eq i32 %index.next34.us, %n.vec30
  br i1 %29, label %vec.epilog.middle.block.us, label %vec.epilog.vector.body.us, !llvm.loop !47
...
for.body4.us:                                     ; preds = %iter.check, %for.body4.us
  %j.020.us = phi i32 [ 0, %iter.check ], [ %inc.us, %for.body4.us ]
  %add.us = add nsw i32 %j.020.us, %mul.us
  %arrayidx.us = getelementptr inbounds i32, ptr addrspace(4) %a, i32 %add.us
  %30 = load i32, ptr addrspace(4) %arrayidx.us, align 4, !tbaa !3
  %mul5.us = mul nsw i32 %j.020.us, %M
  %add6.us = add nsw i32 %mul5.us, %i.022.us
  %arrayidx7.us = getelementptr inbounds i32, ptr addrspace(4) %t, i32 %add6.us
  store i32 %30, ptr addrspace(4) %arrayidx7.us, align 4, !tbaa !3
  %inc.us = add nuw nsw i32 %j.020.us, 1
  %cmp2.us = icmp slt i32 %inc.us, %N
  br i1 %cmp2.us, label %for.body4.us, label %for.cond.cleanup3.us, !llvm.loop !45

iter.check:                                       ; preds = %iter.check.preheader, %for.cond.cleanup3.us
  %i.022.us = phi i32 [ %inc9.us, %for.cond.cleanup3.us ], [ 0, %iter.check.preheader ]
  %mul.us = mul nsw i32 %i.022.us, %N
  br label %for.body4.us

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3.us, %for.body4.us.us38, %vec.epilog.middle.block.us, %vector.body.us.us, %for.body4.us.us38.us, %vec.epilog.vector.body.us.us.us, %for.cond.cleanup3.us.loopexit.us, %entry
  ret void
}
...
entry:
  tail call void @vekt_transpose(i32 noundef %M, i32 noundef %N, ptr noundef %a, ptr noundef %a, i32 noundef 0, i32 noundef %M, i32 noundef %N, i32 noundef %N, i32 noundef 1, ptr noundef %t, ptr noundef %t, i32 noundef 0, i32 noundef %N, i32 noundef %M, i32 noundef %M, i32 noundef 1) #11
  ret void
}
