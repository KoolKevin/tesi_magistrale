...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %vec.ind = phi <16 x i32> [ %vec.ind.next, %vector.body ], [ <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>, %vector.body.preheader ]
  ...
  store <16 x i32> %vec.ind, ptr addrspace(4) %3, align 16, !tbaa !3
...
for.cond.cleanup:                                 ; preds = %vector.body
  ...
  %call4 = call i32 @dotp(ptr noundef %5, ptr noundef %6, i32 noundef 1024) #4
  ...
  %8 = fmul fast double %conv16, 1.000000e+03
  %mul20 = fdiv fast double %8, %conv18
  ...
  %puts89 = call i32 @puts(ptr nonnull dereferenceable(1) @str.10)
  ...
  %9 = fmul fast double %conv31, 1.000000e+03
  %mul35 = fdiv fast double %9, %conv33
  ...
  %puts91 = call i32 @puts(ptr nonnull dereferenceable(1) @str.11)
  %call42 = call i32 @clock() #4
  %call43 = call i32 @vekt_dotp_wrapper(ptr noundef %5, ptr noundef %6, i32 noundef 1024) #4
  %call44 = call i32 @clock() #4
  %sub45 = sub nsw i32 %call44, %call42
  %conv46 = sitofp i32 %sub45 to double
  %call47 = call i32 @_timer_clocks_per_sec() #4
  %conv48 = uitofp i32 %call47 to double
  %10 = fmul fast double %conv46, 1.000000e+03
  %mul50 = fdiv fast double %10, %conv48
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8, double noundef nofpclass(nan inf) %mul50)
  %div52 = fdiv fast double %mul, %mul50
  %call53 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef nofpclass(nan inf) %div52)
  %call54 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %call43)
...
declare i32 @vekt_dotp_wrapper(ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2
