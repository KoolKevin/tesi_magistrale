...
@res = addrspace(4) global [8 x i32] zeroinitializer, align 4
...
@.str.3 = private unnamed_addr constant [59 x i8] c"Tempo di esecuzione di vectorized_mat_reduce_rows: %.2fms\0A\00", align 1
@.str.4 = private unnamed_addr constant [15 x i8] c"Speedup: %.2f\0A\00", align 1
@.str.6 = private unnamed_addr constant [63 x i8] c"Tempo di esecuzione di autovectorized_mat_reduce_rows: %.2fms\0A\00", align 1
@.str.8 = private unnamed_addr constant [53 x i8] c"Tempo di esecuzione di vekt_mat_reduce_rows: %.2fms\0A\00", align 1
...
entry:
  %groundtruth = alloca [8 x i32], align 4
  tail call void @init_matrix(ptr noundef addrspacecast (ptr addrspace(4) @a to ptr), i32 noundef 8, i32 noundef 1024, i32 noundef 1) #5
  tail call void @init_vector(ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8, i32 noundef 0) #5
  %call = tail call i32 @clock() #5
  tail call void @mat_reduce_rows(ptr noundef addrspacecast (ptr addrspace(4) @a to ptr), ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8, i32 noundef 1024) #5
  ...
  tail call void @print_vector(ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8) #5
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %groundtruth) #5
  %1 = load <8 x i32>, ptr addrspace(4) @res, align 4, !tbaa !3
  store <8 x i32> %1, ptr %groundtruth, align 4, !tbaa !3
  ...
  tail call void @vectorized_mat_reduce_rows(ptr addrspace(4) noundef @a, ptr addrspace(4) noundef @res, i32 noundef 8, i32 noundef 1024) #5
  ...
  tail call void @print_vector(ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8) #5
  call void @check_result(ptr noundef nonnull %groundtruth, ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8) #5
  %putchar64 = call i32 @putchar(i32 10)
  %puts = call i32 @puts(ptr nonnull dereferenceable(1) @str)
  call void @init_vector(ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8, i32 noundef 0) #5
  %call22 = call i32 @clock() #5
  call void @autovectorized_mat_reduce_rows(ptr addrspace(4) noundef @a, ptr addrspace(4) noundef @res, i32 noundef 8, i32 noundef 1024) #5
  ...
  call void @print_vector(ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8) #5
  call void @check_result(ptr noundef nonnull %groundtruth, ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8) #5
  %putchar65 = call i32 @putchar(i32 10)
  %puts66 = call i32 @puts(ptr nonnull dereferenceable(1) @str.9)
  call void @init_vector(ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8, i32 noundef 0) #5
  %call36 = call i32 @clock() #5
  call void @vekt_mat_reduce_rows_wrapper(ptr noundef addrspacecast (ptr addrspace(4) @a to ptr), ptr noundef addrspacecast (ptr addrspace(4) @res to ptr), i32 noundef 8, i32 noundef 1024) #5
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %groundtruth) #5
  ret i32 0
}
...
declare void @mat_reduce_rows(ptr noundef, ptr noundef, i32 noundef, i32 noundef) local_unnamed_addr #1
...
declare void @vectorized_mat_reduce_rows(ptr addrspace(4) noundef, ptr addrspace(4) noundef, i32 noundef, i32 noundef) local_unnamed_addr #1

declare void @check_result(ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #1

declare void @autovectorized_mat_reduce_rows(ptr addrspace(4) noundef, ptr addrspace(4) noundef, i32 noundef, i32 noundef) local_unnamed_addr #1

declare void @vekt_mat_reduce_rows_wrapper(ptr noundef, ptr noundef, i32 noundef, i32 noundef) local_unnamed_addr #1
